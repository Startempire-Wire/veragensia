...
The existing lowercase `wirebot` Linux/service account used by Veragensia infrastructure is an execution identity only and has **zero architecture authority**.
